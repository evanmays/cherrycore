...
iverilog -g2012 ../core/FIFO/fake_instruction_queue.sv $UART/rtl/uart_tx.v ../core/Dma/dma_uart.sv ../core/top.sv 
/usr/local/bin/yosys  -p "synth_xilinx -flatten -nowidelut -family xc7 -top top; write_json attosoc.json" ../core/FIFO/fake_instruction_queue.sv $UART/rtl/uart_tx.v ../core/Dma/dma_uart.sv ../core/top.sv 
