...
iverilog -g2012 -Wall ../core/types.sv ../core/Memory/fake_pcache.sv ../core/Processing/pipeline.sv ../core/Memory/regfile.sv ../core/Memory/dcache.sv ../core/FIFO/varray.sv ../core/FIFO/iq.sv $UART/rtl/uart_tx.v $UART/rtl/uart_rx.v ../core/Dma/dma_uart.sv ../core/ControlUnit/loopmux.sv ../core/ControlUnit/control_unit.sv ../core/top.sv
/usr/local/bin/yosys  -p "synth_xilinx -nodsp -flatten -nowidelut -family xc7 -top top; write_json attosoc.json" ../core/types.sv ../core/Memory/fake_pcache.sv ../core/Processing/pipeline.sv ../core/Memory/regfile.sv  ../core/Memory/dcache.sv ../core/FIFO/varray.sv ../core/FIFO/iq.sv $UART/rtl/uart_tx.v $UART/rtl/uart_rx.v ../core/Dma/dma_uart.sv ../core/ControlUnit/loopmux.sv ../core/ControlUnit/control_unit.sv  ../core/top.sv 
