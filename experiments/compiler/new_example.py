#!/usr/bin/env python3
from compiler import cherry_program, cisa_load, cisa_unop, cisa_store, SZ, cherry_range, GhostTensor, GhostOutputTensorBuilder, Slot, Reg, cisa_mem_read, cisa_mem_write
import numpy as np

# ==== Define your programs ====

@cherry_program(title="Relu")
def cherry_relu(x: GhostTensor, output: GhostOutputTensorBuilder):
