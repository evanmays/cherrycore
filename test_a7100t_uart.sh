...
cd out
UART=../bigvendor/uart
/usr/local/bin/yosys  -p "synth_xilinx -flatten -nowidelut -family xc7 -top impl_top; write_json attosoc.json" $UART/rtl/impl_top.v $UART/rtl/uart_rx.v $UART/rtl/uart_tx.v
...
python3 bigvendor/uart/comms.py